...
def resetTheAvailability():
   c = flightUtil.connection()
   cur = c.cursor()
   cur.execute(flightUtil.resetDirectFlightAvailabilityQuery)
   cur.fetchall()
   cur.execute(flightUtil.commit)
   cur.fetchall()
   cur.execute(flightUtil.resetOneStopFlightAvailabilityQuery)
   cur.fetchall()
   cur.execute(flightUtil.commit)
   cur.fetchall()
   cur.execute(flightUtil.resetTwoStopFlightAvailabilityQuery)
   cur.fetchall()
   cur.execute(flightUtil.commit)
   cur.fetchall()
